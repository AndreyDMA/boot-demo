...
import mate.academy.boot.bootdemo.dto.BookDto;
import mate.academy.boot.bootdemo.dto.BookDtoUtil;
...
public class BookController {
    ...
    @PutMapping("/{id}")
    public Book update(@PathVariable("id") Long id, BookDto bookDto) {
        Book book = BookDtoUtil.createBookFromDto(bookDto);
